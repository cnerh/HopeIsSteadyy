<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageSingleMenu.Master" AutoEventWireup="true" CodeBehind="Grid.aspx.cs" Inherits="HopeIsSteady.Grid" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <telerik:RadAjaxPanel ID="RadAjaxPanel1" ClientEvents-OnRequestStart="onRequestStart" runat="server" CssClass="grid_wrapper">
        <telerik:RadGrid ID="RadGrid1" runat="server" PagerStyle-PageButtonCount="5"
            ...
            AllowPaging="True" AllowSorting="True" ShowGroupPanel="True" RenderMode="Auto" CellSpacing="-1" DataSourceID="SqlDataSource1" GridLines="Both">
            <GroupingSettings ShowUnGroupButton="true" />
            <ExportSettings ExportOnlyData="true" IgnorePaging="true"></ExportSettings>
            <MasterTableView AutoGenerateColumns="False"
                AllowFilteringByColumn="true" TableLayout="Fixed"
                DataKeyNames="ServiceId" CommandItemDisplay="Top"
                InsertItemPageIndexAction="ShowItemOnFirstPage" DataSourceID="SqlDataSource1">
                ...
                <Columns>
                    <telerik:GridBoundColumn DataField="ServiceId" HeaderText="ServiceId" SortExpression="ServiceId"
                        UniqueName="ServiceId" DataType="System.Int32" FilterControlAltText="Filter ServiceId column" ReadOnly="True">
                    ...
                    <telerik:GridBoundColumn DataField="ServicePicture" FilterControlAltText="Filter ServicePicture column" HeaderText="ServicePicture" SortExpression="ServicePicture" UniqueName="ServicePicture">
                    </telerik:GridBoundColumn>
                </Columns>
            </MasterTableView>
